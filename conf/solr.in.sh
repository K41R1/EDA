...
SOLR_OPTS="$SOLR_OPTS -Dsolr.environment=prod,label=Exploratory+Data+Analysis"
##
# Run on HDFS
# SOLR_OPTS="$SOLR_OPTS -Dsolr.directoryFactory=HdfsDirectoryFactory"
# SOLR_OPTS="$SOLR_OPTS -Dsolr.lock.type=hdfs"
# SOLR_OPTS="$SOLR_OPTS -Dsolr.updatelog=hdfs://namenode:9000/logs/solr"
# SOLR_OPTS="$SOLR_OPTS -Dsolr.hdfs.home=hdfs://namenode:9000/solr"
# SOLR_OPTS="$SOLR_OPTS -Dsolr.hdfs.blockcache.enabled=true"
# SOLR_OPTS="$SOLR_OPTS -Dsolr.hdfs.blockcache.slab.count=1"
...
# SOLR_OPTS="$SOLR_OPTS -Dsolr.hdfs.blockcache.read.enabled=true"
# SOLR_OPTS="$SOLR_OPTS -Dsolr.hdfs.nrtcachingdirectory.enable=true"
# SOLR_OPTS="$SOLR_OPTS -Dsolr.hdfs.nrtcachingdirectory.maxmergesizemb=16"
# SOLR_OPTS="$SOLR_OPTS -Dsolr.hdfs.nrtcachingdirectory.maxcachedmb=192"